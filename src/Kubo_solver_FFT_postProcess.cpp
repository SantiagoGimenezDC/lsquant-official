...
void Kubo_solver_FFT_postProcess::Greenwood_postProcess(const value_t final_data[], const value_t r_data[], int r){
  ...
  */
  ...
  for(int k=0; k < nump; k++){
    rvec_partial_result[k] = 2.0 * omega * real( r_data[k] )     / (1.0 - E_points_[k] * E_points_[k] );
...
Kubo_solver_FFT_postProcess_dup::Kubo_solver_FFT_postProcess_dup(Kubo_solver_FFT_kQuant_nonOrth& parent_solver): parent_solver_(parent_solver){
  int nump = parent_solver_.nump();
...
void Kubo_solver_FFT_postProcess_dup::operator()(const value_t final_data[], const value_t r_data[], int r){
  if(parent_solver_.SolverFormula() == KUBO_GREENWOOD)
    Greenwood_postProcess(final_data, r_data, r);
  if(parent_solver_.SolverFormula() == KUBO_BASTIN)
    Bastin_postProcess(final_data, r_data, r);
...
void Kubo_solver_FFT_postProcess_dup::eta_CAP_correct(r_value_t E_points[], r_value_t r_data[]){
  int nump = parent_solver_.nump();
...
void Kubo_solver_FFT_postProcess_dup::integration_linqt(const r_value_t E_points[], const r_value_t integrand[], r_value_t data[]){
...
void Kubo_solver_FFT_postProcess_dup::integration(const r_value_t E_points[], const r_value_t integrand[], r_value_t data[]){
...
void Kubo_solver_FFT_postProcess_dup::partial_integration(const r_value_t E_points[], const r_value_t integrand[], r_value_t data[]){
...
void Kubo_solver_FFT_postProcess_dup::rearrange_crescent_order( r_value_t* rearranged){//The point choice of the FFT has unconvenient ordering for file saving and integrating; This fixes that.
  int nump = parent_solver_.nump();
  r_value_t original[nump];
...
void Kubo_solver_FFT_postProcess_dup::Bastin_postProcess(const value_t final_data[], const value_t r_data[],  int r){
...
void Kubo_solver_FFT_postProcess_dup::Greenwood_postProcess(const value_t final_data[], const value_t r_data[], int r){
...
void Kubo_solver_FFT_postProcess_dup::plot_data(const std::string& run_dir, const std::string& filename){
        //VIEW commands
...
Kubo_solver_FFT_postProcess_dup_dup::Kubo_solver_FFT_postProcess_dup_dup(Kubo_solver_FFT_kQuant& parent_solver): parent_solver_(parent_solver){
  int nump = parent_solver_.nump();
...
void Kubo_solver_FFT_postProcess_dup_dup::operator()(const value_t final_data[], const value_t r_data[], int r){
  if(parent_solver_.SolverFormula() == KUBO_GREENWOOD)
    Greenwood_postProcess(final_data, r_data, r);
  if(parent_solver_.SolverFormula() == KUBO_BASTIN)
    Bastin_postProcess(final_data, r_data, r);
...
void Kubo_solver_FFT_postProcess_dup_dup::eta_CAP_correct(r_value_t E_points[], r_value_t r_data[]){
  int nump = parent_solver_.nump();
...
void Kubo_solver_FFT_postProcess_dup_dup::integration_linqt(const r_value_t E_points[], const r_value_t integrand[], r_value_t data[]){
...
void Kubo_solver_FFT_postProcess_dup_dup::integration(const r_value_t E_points[], const r_value_t integrand[], r_value_t data[]){
...
void Kubo_solver_FFT_postProcess_dup_dup::partial_integration(const r_value_t E_points[], const r_value_t integrand[], r_value_t data[]){
...
void Kubo_solver_FFT_postProcess_dup_dup::rearrange_crescent_order( r_value_t* rearranged){//The point choice of the FFT has unconvenient ordering for file saving and integrating; This fixes that.
  int nump = parent_solver_.nump();
  r_value_t original[nump];
...
void Kubo_solver_FFT_postProcess_dup_dup::Bastin_postProcess(const value_t final_data[], const value_t r_data[],  int r){
...
void Kubo_solver_FFT_postProcess_dup_dup::Greenwood_postProcess(const value_t final_data[], const value_t r_data[], int r){
...
void Kubo_solver_FFT_postProcess_dup_dup::plot_data(const std::string& run_dir, const std::string& filename){
        //VIEW commands
...
Kubo_solver_FFT_postProcess_dup_dup_dup::Kubo_solver_FFT_postProcess_dup_dup_dup(Kubo_solver_FFT_kQuant_nonOrth_ChrisVel& parent_solver): parent_solver_(parent_solver){
  int nump = parent_solver_.nump();
...
void Kubo_solver_FFT_postProcess_dup_dup_dup::operator()(const value_t final_data[], const value_t r_data[], int r){
  if(parent_solver_.SolverFormula() == KUBO_GREENWOOD)
    Greenwood_postProcess(final_data, r_data, r);
  if(parent_solver_.SolverFormula() == KUBO_BASTIN)
    Bastin_postProcess(final_data, r_data, r);
...
void Kubo_solver_FFT_postProcess_dup_dup_dup::eta_CAP_correct(r_value_t E_points[], r_value_t r_data[]){
  int nump = parent_solver_.nump();
...
void Kubo_solver_FFT_postProcess_dup_dup_dup::integration_linqt(const r_value_t E_points[], const r_value_t integrand[], r_value_t data[]){
...
void Kubo_solver_FFT_postProcess_dup_dup_dup::integration(const r_value_t E_points[], const r_value_t integrand[], r_value_t data[]){
...
void Kubo_solver_FFT_postProcess_dup_dup_dup::partial_integration(const r_value_t E_points[], const r_value_t integrand[], r_value_t data[]){
...
void Kubo_solver_FFT_postProcess_dup_dup_dup::rearrange_crescent_order( r_value_t* rearranged){//The point choice of the FFT has unconvenient ordering for file saving and integrating; This fixes that.
  int nump = parent_solver_.nump();
  r_value_t original[nump];
...
void Kubo_solver_FFT_postProcess_dup_dup_dup::Bastin_postProcess(const value_t final_data[], const value_t r_data[],  int r){
...
void Kubo_solver_FFT_postProcess_dup_dup_dup::Greenwood_postProcess(const value_t final_data[], const value_t r_data[], int r){
...
void Kubo_solver_FFT_postProcess_dup_dup_dup::plot_data(const std::string& run_dir, const std::string& filename){
        //VIEW commands
