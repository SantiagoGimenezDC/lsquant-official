...
#include "linear_algebra.hpp"
	...
	//light functions
int chebyshev::Moments_Graphene_NNN::JacksonKernelMomCutOff( const double broad )
{
	assert( broad >0 );
...
//light functions
double chebyshev::Moments_Graphene_NNN::JacksonKernel(const double m,  const double Mom )
{
	const double
...
int chebyshev::Moments_Graphene_NNN::Iterate( )
{
