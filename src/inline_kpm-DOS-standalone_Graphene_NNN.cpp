...
void postProcess(chebyshev::Moments1D_Graphene_NNN& );
...
int main(int argc, char *argv[])
{
	...
	chebyshev::SpectralMoments_Graphene_NNN(OP[1],chebMoms, gen);
...
void postProcess(chebyshev::Moments1D_Graphene_NNN& mu ){
