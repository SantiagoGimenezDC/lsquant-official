...
Graphene_NNN::Graphene_NNN(int is_k_space, r_type range, r_type stgr_str, r_type m_str, r_type rashba_str, r_type KM_str, r_type HLD_str, device_vars& parameters):
...
void Graphene_NNN::J (type* ket, type* p_ket, int dir){
...
void Graphene_NNN::spin_project (type* ket, int dir){
...
void Graphene_NNN::traceover(type* traced, type* full_vec, int s, int num_reps){
...
void Graphene_NNN::print_hamiltonian(){
...
void Graphene_NNN::Hr_ket (r_type a, r_type b, type* ket, type* p_ket){
...
void Graphene_NNN::Hr_update_cheb ( type ket[], type p_ket[], type pp_ket[]){
  size_t Le = this->parameters().LE_,
    W  = this->parameters().W_,
    Dim = this->parameters().DIM_;
