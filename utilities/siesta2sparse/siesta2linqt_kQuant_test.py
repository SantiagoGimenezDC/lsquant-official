...
def build_operators(H_source, kx: int, ky: int, kz: int, gauge: str):
    ...
    Sinv_blk = block_diag(Sinv_list, format='csr')
    print("done")

    return H_blk, Vx_blk, Vy_blk, Sinv_blk, Ks
...
def main():
    ...
    H_blk, Vx_blk, Vy_blk, Sinv_blk, Ks = build_operators(
